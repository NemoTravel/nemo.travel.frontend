...
<div class="nemo-common-pageWrapper">
	<header class="nemo-common-pageHeader">
		<div class="nemo-common-pageHeader__inner">
			<div class="new-ui-headerMenuControls nemo-common-pageHeader__inner__headerMenuControlls">
			...
			<div class="nemo-common-pageHeader__inner__headerLinks">
				<button class="new-ui-button new-ui-button_common new-ui-button_medium">Войти</button>
				<a href="#" class="new-ui-pseudoLink new-ui-pseudoLink_blue">
					Регистрация
				</a>
				<a href="#" class="new-ui-pseudoLink new-ui-link_blue">
					Состояние заказа
				</a>
			</div>
			<div class="nemo-common-pageHeader__inner__headerRight">
				<div class="new-ui-dropMenu">
					<div class="new-ui-dropMenu__main">
						<button class="new-ui-button new-ui-button_common new-ui-button_medium">
